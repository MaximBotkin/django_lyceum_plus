    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_subscribed', models.BooleanField(default=True, verbose_name='Подписка активна')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_who_has_subscribers', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь')),
